...
export class PersistenceService {
    ...
    loadRitualState() {
        try {
            ...
            const state = JSON.parse(stateData, this.dateReviver);
    ...
    async loadRitual(ritualId) {
        try {
            ...
            return JSON.parse(ritualData, this.dateReviver);
        }
        catch (error) {
    ...
    async getRitualHistory(limit) {
        try {
            const historyData = await this.storage.get(PersistenceService.KEYS.HISTORY);
            if (!historyData) {
                return [];
            }
            const history = JSON.parse(historyData, this.dateReviver);
    ...
    async restoreFromBackup(timestamp) {
        try {
            ...
            return JSON.parse(backupData, this.dateReviver);
        }
        catch (error) {
