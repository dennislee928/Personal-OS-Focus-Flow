...
export class ContextTagger {
     ...
     */
    getContextExplanation(contextId) {
        const context = this.state.availableContexts.find(c => c.id === contextId);
    ...
    generateContextSuggestion(item) {
        // Find matching rules
